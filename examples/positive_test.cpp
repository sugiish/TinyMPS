...
int main(int argc, char* argv[]) {
  try {
    std::string output_path = "./pos_test/";
    std::string input_data = "./input/positive.data";
    std::string input_grid = "./input/positive.grid";
    ...
    Eigen::Vector3d minpos(-4.1, -4.1, 0);
    Eigen::Vector3d maxpos(4.1, 4.1, 0);
